...
public class EIMPreferences {
	...
	// Scelta algoritmo per il riconoscimento facciale
	 private String recognitionTypeKey;
	 private String recognitionTypeDefault;

	public AllFaceRecognizer.Type recognitionType() {
		//return EIMFaceRecognizer.Type.LBPH;
		String mType = mSharedPreferences.getString(recognitionTypeKey, recognitionTypeDefault);
		AllFaceRecognizer.Type[] recognitionTypes = AllFaceRecognizer.Type.values();
	...
	public AllFaceRecognizer.CutMode recognitionCutMode() {
		String mCutMode = mSharedPreferences.getString(recognitionCutModeKey,
				recognitionCutModeDefault);
		AllFaceRecognizer.CutMode[] recognitionCutModes = AllFaceRecognizer.CutMode
				.values();
	...
	public int EigenComponents() {
		//return 0;
		 return Integer.parseInt(mSharedPreferences.getString(EigenComponentsKey, EigenComponentsDefault));
	}
	...
	public int FisherComponents() {
		//return 0;
		 return Integer.parseInt(mSharedPreferences.getString(FisherComponentsKey, FisherComponentsDefault));
	}
	...
	private void getKeysAndDefaultValues(Context mContext) {
		...
		recognitionTypeDefault = mContext.getString(R.string.recognition_recognizer_type_default);
		...
		//nuovo!!!!!!!!
		EigenComponentsKey = mContext.getString(R.string.recognition_eigen_components);
        EigenComponentsDefault = mContext.getString(R.string.recognition_eigen_components_default);

        FisherComponentsKey = mContext.getString(R.string.recognition_fisher_components);
        FisherComponentsDefault = mContext.getString(R.string.recognition_fisher_components_default);
